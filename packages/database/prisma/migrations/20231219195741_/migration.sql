/*
  ...
  - You are about to drop the column `name` on the `Parliamentarian` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Parliamentarian" DROP COLUMN "name",
